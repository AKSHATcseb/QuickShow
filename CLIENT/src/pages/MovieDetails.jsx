...
const MovieDetails = () => {
  ...
  return show ?
    (
      <div className='px-6 md:px-16 lg:px-40 pt-30 mt-52 md:pt-50' >
        <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>

          <img src={show.movie.poster_path} alt="" className='max-md:mx-auto rounded-xl h-96 max-w-70 object-cover' />
          ...
          <div className='relative flex flex-col gap-3'>
            ...
            <p>
              {timeFormat(show.movie.runtime)} &middot; {show.movie.genres.map(genre => genre.name).join(", ")} &middot; {show.movie.release_date.split("-")[0]}
            </p>
