...
const DateSelect = ({ dateTime, id }) => {
    ...
    return (
        <div id='dateSelect' className='pt-36 font-outfit'>
            <div className='flex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-[#F84565]/10 border border-[#F84565]/20 rounded-lg'>
                ...
                <button onClick={onBookHandler} className='bg-[#F84565] text-white px-8 py-2 mt-6 rounded hover:bg-[#F84565]/90 transition-all cursor-pointer'>Book Now</button>
            </div>
        </div>
    )
}
